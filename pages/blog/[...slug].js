...
const BlogDetails = () => {
  ...
  const itemShow = data?.find((item) => item.id == roomId);
          ...
          <div className="row">
            <div className="col-lg-12">
              ...
              <div className="cover_img">
                <Image
                  className="img-fluid"
                  src={`/assets/images/blog/${itemShow?.img}.webp`}
                  alt=""
                  width={2000}
                  height={700}
                />
              ...
              <div className="content">
                ...
                <div className="tags">
                  {itemShow?.comment_tag.map((item) => (
                    <Link key={item.id} href={item.title} className="tag-item">
                      {item.title}
                    </Link>
                  ))}
                </div>
                ...
                {itemShow?.comment.map((item) => (
                  <div key={item.id} className="commenting">
                    <div className="commenting-img">
                      <Image
                        src={`/assets/images/blog-details/${item.comment_img}.webp`}
                        alt=""
                        width={100}
                        height={100}
                      />
