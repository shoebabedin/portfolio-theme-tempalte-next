...
const Contact = () => {
  ...
  return (
    <>
      ...
      <HeadAbout title={"Contact Us"} breadcum={"Contact"} />
            ...
            <div className="col-lg-5">
              <div className="comments">
                ...
                <div className="contact-item">
                  ...
                  <div>
                    <h4>Call Me</h4>
                    <Link href="callto:+77 022 155 02 02"><p>+77 022 155 02 02</p></Link>
                  </div>
                </div>
                <div className="contact-item">
                  <span>
                  ...
                  <div>
                    <h4>Email Me</h4>
                    <Link href="mailto:example@gmail.com"><p>example@gmail.com</p></Link>
                  </div>
                </div>
              </div>
            </div>
